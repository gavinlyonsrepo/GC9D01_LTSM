/*!
	@file   DEMOS.ino
	@author Gavin Lyons
	@brief   Example file for GC9D01_LTSM arduino library. gauge demo
	@note   See USER OPTIONS 1-2 in SETUP function
			    If dislib16_ADVANCED_GRAPHICS_ENABLE is not enabled it will not compile
          This settings are in file :display16_common_LTSM.hpp
            of graphics library. This example is for 160x160 Dual gate.
	@test
		-# Test 409 gauge demo 
*/
